        ...
        return (function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, node_fetch_1.default("https://api.github.com/users/" + userName)];
                        case 1:
                            res = _a.sent();
    ...
    GithubApiService.prototype.getRepos = function (userName) {
        return (function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, node_fetch_1.default("https://api.github.com/users/" + userName + "/repos")];
                        case 1:
                            res = _a.sent();
                            return [4 /*yield*/, res.json()];
                        case 2:
                            data = _a.sent();
                            repos = data.map(function (repo) { return new Repo_1.default(repo); });
